...
class CaptchaSystemTester {
  ...
  showResults() {
    ...
    if (failed === 0) {
      ...
      console.log('   psql -f supabase/migrations/20250130000014_add_captcha_detection_system.sql');
  ...
  async createMockCaptchaTestPage() {
    const start = Date.now();
...
module.exports = { CaptchaSystemTester }; 