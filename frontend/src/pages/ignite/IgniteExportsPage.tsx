            ...
            {exportsData.map((row) => (
              <tr key={row.id}>
                <td className="px-4 py-4">
                  <p className="font-semibold text-slate-900">{row.proposal_name || 'Untitled Proposal'}</p>
                  <p className="text-xs text-slate-500">{row.proposal_id}</p>
                </td>
                ...
                <td className="px-4 py-4 text-right">
                  {row.file_url ? (
                    ...
                    <span className="text-xs text-slate-500">No file URL yet</span>
                  )}
                </td>
              </tr>
            ))}
