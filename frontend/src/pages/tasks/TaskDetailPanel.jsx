  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 lg:relative lg:z-30 lg:w-[400px] lg:h-screen lg:max-h-screen lg:sticky lg:top-0 lg:self-start bg-white border-l border-gray-200 flex flex-col h-full shadow-drawer overflow-hidden">
        ...
        {/* Desktop header */}
        <div className="hidden lg:flex px-6 py-4 border-b border-gray-200 items-center justify-between flex-shrink-0">
        ...
        <div className="flex lg:hidden items-center justify-between px-4 py-2 border-b border-gray-100 flex-shrink-0">
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <span className="bg-gray-100 px-2 py-1 rounded-md border border-gray-200 font-mono text-gray-600">{task.code}</span>
            <span>•</span>
            <span>{task.createdAt}</span>
