  ...
  return (
    <div>
      ...
      <div className="flex gap-2">
        <input className="flex-1 bg-slate-800 border border-slate-600 rounded px-3 py-2 text-slate-100 placeholder-slate-400 focus:outline-none focus:border-blue-500" value={input} onChange={(e)=>setInput(e.target.value)} placeholder={placeholder} onKeyDown={(e)=>{ if (e.key==='Enter'){ e.preventDefault(); add(); } }} />
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-2xl rounded-2xl border border-slate-700 bg-slate-900 p-6">
        ...
        <form className="space-y-4" onSubmit={onSubmit}>
          ...
          <TagInput label="Titles / Roles" values={titles} onChange={setTitles} placeholder="Add a title then press Enter" />
