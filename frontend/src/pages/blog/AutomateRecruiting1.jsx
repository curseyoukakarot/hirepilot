        ...
        <div id="toc-sidebar" className="hidden lg:block w-64 flex-shrink-0">
          <div className="sticky top-8">
            ...
            <nav className="space-y-2">
              <span className="block text-gray-400 hover:text-white transition-colors py-1 cursor-pointer">The Vision</span>
              <span className="block text-gray-400 hover:text-white transition-colors py-1 cursor-pointer">Meet REX: Your AI Copilot</span>
              <span className="block text-gray-400 hover:text-white transition-colors py-1 cursor-pointer">Why Automate Recruiting?</span>
              <span className="block text-gray-400 hover:text-white transition-colors py-1 cursor-pointer">What This Series Covers</span>
              <span className="block text-gray-400 hover:text-white transition-colors py-1 cursor-pointer">Getting Started</span>
            </nav>
          </div>
        </div>
