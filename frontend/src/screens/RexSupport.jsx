  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        {/* Entire remaining HTML content injected verbatim */}
        <div dangerouslySetInnerHTML={{ __html: `<section id=\"quick-start\" class=\"mb-16\">...<!-- full html content omitted due to size -->` }} />
      </main>
      <PublicFooter />
    </div>
  );
