          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 flex flex-col items-center justify-center gap-12">
            <div className="w-full max-w-3xl text-center">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 sm:justify-start justify-center">
                <a href="https://form.typeform.com/to/UubjS8Rh" target="_blank" rel="noopener" className="bg-white text-blue-600 font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-white/25 transition-all duration-200">
