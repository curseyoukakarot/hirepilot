        ...
        <section id="use-cases" className="py-20 px-6 bg-gray-800">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <a href="/use-cases" className="group bg-gray-900 p-8 rounded-2xl card-shadow hover-lift transition-all duration-300 border border-gray-800">
                <div className="mb-6">
                  <div className="w-16 h-16 bg-indigo-900 rounded-xl flex items-center justify-center mb-4 group-hover:bg-indigo-800 transition">
                    <i className="fa-solid fa-briefcase text-2xl text-indigo-400"></i>
                  </div>
                  <h3 className="text-2xl font-semibold mb-3 text-white">Productized Service Creators</h3>
                  <p className="text-gray-400 leading-relaxed">You sell the offer — HirePilot handles the fulfillment, client flow, and recurring revenue.</p>
                </div>
                <div className="flex items-center text-indigo-400 font-semibold group-hover:text-indigo-300 transition">
                  <span>Explore</span>
                  <i className="fa-solid fa-arrow-right ml-2 group-hover:translate-x-1 transition"></i>
