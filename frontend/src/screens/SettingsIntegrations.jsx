      ...
      <div className="p-6">
        <div className="max-w-3xl mx-auto">
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
            <h2 className="text-xl font-semibold text-yellow-800 mb-2">Integrations are a paid feature</h2>
            <p className="text-yellow-700 mb-4">Upgrade to connect Slack, Zapier, Apollo, and more.</p>
            <a href="/pricing" className="inline-flex items-center bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">See Plans</a>
          </div>
        </div>
      </div>
    );
