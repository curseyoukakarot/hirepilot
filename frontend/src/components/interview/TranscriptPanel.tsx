      ...
      <div className="h-16 px-6 border-b border-white/5 flex items-center justify-between bg-[#080808]/95 backdrop-blur sticky top-0 z-10">
        ...
        <div className="flex flex-col items-end">
          <div className="flex items-center text-xs text-gray-500 mb-1">
            <span className="text-white font-medium mr-1">Q3</span> of 8
          </div>
          <div className="w-24 h-1 bg-gray-800 rounded-full overflow-hidden">
            <div className="w-[37.5%] h-full bg-blue-500 rounded-full"></div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8 transcript-scroll pb-32">
        <div className="flex flex-col space-y-3">
          <div className="flex items-center space-x-2 mb-1">
            ...
            <span className="text-xs text-gray-600">14:18</span>
          </div>
          <div className="bg-[#121212] border border-white/5 p-5 rounded-2xl rounded-tl-none shadow-sm max-w-[90%]">
            <p className="text-gray-300 leading-relaxed text-sm">
              Let&apos;s start with a classic product question. Tell me about a time you had to make a difficult
              prioritization decision where stakeholders were conflicted. How did you handle it?
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-end space-y-3">
          <div className="flex items-center space-x-2 mb-1 flex-row-reverse space-x-reverse">
            ...
            <span className="text-xs text-gray-600">14:19</span>
          </div>
          <div className="text-right max-w-[90%]">
            <p className="text-gray-400 leading-relaxed text-sm">
              Sure. In my last role at TechFlow, we were launching a new analytics dashboard. Sales wanted more export
              features for enterprise clients, but engineering was pushing back because of technical debt concerns. The
              deadline was tight.
            </p>
            <p className="text-gray-400 leading-relaxed text-sm mt-2">
              I decided to hold a workshop to align everyone. We looked at the data and realized only 5% of users
              actually used the export feature. So, I proposed we delay the advanced export features to v2 and focus on
              stability first.
            </p>
          </div>
        </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-xs text-gray-400">
                    <span className="text-gray-200 font-medium">Good structure:</span> You clearly identified the
                    conflict (Sales vs. Eng) and the constraint (deadline).
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-xs text-gray-400">
                    <span className="text-gray-200 font-medium">Impact missing:</span> Mention the outcome. Did the v1
                    launch succeed? Did sales agree easily?
                  </p>
                </div>
                <div className="mt-3 pt-3 border-t border-white/5">
                  <button className="flex items-center text-xs text-blue-400 hover:text-blue-300 transition-colors font-medium">
        ...
        <div className="flex flex-col space-y-3 pt-4">
          <div className="flex items-center space-x-2 mb-1">
            ...
            <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">REX</span>
            <span className="text-xs text-gray-600">14:21</span>
          </div>
          <div className="bg-[#121212] border border-white/5 p-5 rounded-2xl rounded-tl-none shadow-sm max-w-[90%]">
            <p className="text-gray-300 leading-relaxed text-sm">
              That makes sense. Can you elaborate on how you convinced the sales team to accept the delay? Was there any
              friction?
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-end space-y-3">
          ...
          <div className="text-right max-w-[90%] relative">
            ...
            <p className="text-gray-200 leading-relaxed text-sm">
              Yes, so I actually sat down with the VP of Sales and showed them the usage data. I explained that if we
              shipped the buggy version...
            </p>
          </div>
        </div>
      </div>
