...
const ToolPayloadSchema = z.object({
  ...
  job_type: z.enum(['prospect_post_engagers', 'people_search', 'jobs_intent', 'send_connect_requests', 'send_messages', 'decision_maker_lookup', 'sn_lead_search', 'sn_send_connect', 'sn_send_inmail', 'sn_send_message']),
